...
- 🎯 **Currently Working On:** Advanced LLM Security Research & Penetration Testing
- 🎓 **Education:** B.Tech Computer Science Engineering @ Gandhi Engineering College (CGPA: 9.07/10)
- 🌱 **Learning:** AI/ML Security, Advanced Penetration Testing Techniques
- 💡 **Interests:** LLM Vulnerabilities, VAPT, Cybersecurity Research, Open Source Development
...
- Conducted comprehensive VAPT using industry-standard tools (Burp Suite, Nessus, Acunetix)
- Identified **16+ critical web vulnerabilities** across military systems
- Discovered advanced LLM jailbreaks using OWASP Top 10 for LLMs framework
...
### 🚨 Gurugram Police Cyber Security | Cybersecurity Intern
**June – July 2024 | Haryana**
- Identified **3 critical security issues** in law enforcement systems
- Gained expertise in OSINT, Bug Hunting, Digital Forensics, and Dark Web Analysis
- Completed hands-on training at eSec Forte Cyber Forensics Lab
...
### 🔍 RAKSHAK: LLM Vulnerability Scanner
...
*Secure communication tool using LSB steganography with XOR encryption*

🎯 **Key Features:**
- LSB technique with XOR encryption for secure message embedding
- Flask web interface with upload/download functionality
...
### 🛡️ Multi-Algorithm Encryption Suite
...
*Enterprise-grade cryptographic system with multiple algorithm support*

🎯 **Key Features:**
- AES-256, DES, and RSA encryption algorithms
- CLI and web interfaces for versatile usage
...
**Specialized Tools:** WFuzz, Snort, OpenVAS, Nessus, FFuF, Acunetix, Garak, Promptmap, Pyrit

### 🔬 Security Specializations
- **🎯 Vulnerability Assessment & Penetration Testing (VAPT)**
- **🤖 AI/LLM Security & Jailbreak Discovery**
...
- **🏆 CTF Champion:** 3rd Position at IIIT Bhubaneswar CTF Competition
- **🎤 Public Speaking:** Anchored cultural events demonstrating leadership skills

### 📜 Professional Certifications
- **Hardware Security Professional** - ITronix Solutions (ISO 9001:2015) - *April 2025*
...
### 🔬 Research Interests
- **LLM Security Vulnerabilities & Exploitation Techniques**
- **Advanced Penetration Testing Methodologies** 
- **Cryptographic Implementations in Modern Security**
